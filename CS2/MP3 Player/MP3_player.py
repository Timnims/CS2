...
def update_progress_bar():
    global song
    if song.is_playing():
        progress = song.get_position()
        maximum = song.get_length()
        progress_bar.maximum(maximum*100)
        progress_bar.value(progress * 100)
        Fl.repeat_timeout(0.1, update_progress_bar)
    else:
...
progress_bar = Fl_Hor_Slider(50, 475, 300, 25)
